...
| 7 | 8 | Awake mimic (`mimic_0`, `mimic_atk`) | The open chest with a small grin stamped over the gold, on scuffed stick legs. → All mouth: the lid is the upper jaw and the rim the lower, with uneven fangs (one gold), a dull red throat and a fat tongue over the rim. Four short hand-drawn, mirrored jointed legs, crouched with the knees out (a first pass at ten rows was too tall). No eyes. The attack gapes wider, lengthens the fangs and lashes the tongue to the floor. Same 32×32 frame and scale as before. |
