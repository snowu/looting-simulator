...
| 7 | 8 | Awake mimic (`mimic_0`, `mimic_atk`) | The open chest with a small grin stamped over the gold, on scuffed stick legs. → All mouth: the lid is the upper jaw and the rim the lower, with uneven fangs (one gold), a dull red throat and a fat tongue over the rim. Four hand-drawn, mirrored jointed legs, the outer pair kinked out past the box. No eyes. The attack gapes wider, lengthens the fangs and lashes the tongue to the floor. 32×36 so the legs fit, at scale 0.9. |
