...
| What changes | The world is **upside down** — the camera rolls 180°, so the ceiling is beneath you and turning left looks like turning right. Your own weapon stays upright. Pale green daylight, and you can see **30 tiles** instead of 18 | **Black and white**: a luminance pass with the contrast pushed, the dither left on so it grains. The **simulation** runs at **×1.25** — you, the monsters, the shafts in flight and the run clock, scaled once at the top of the world update so nothing can fall out of step with anything else. The renderer's own flicker is not scaled; the torches gutter at their usual rate. A piano rag plays. Every creature wears a **top hat and a monocle**, and every melee weapon in your hands looks like a **cane** |
...
| Throne | the King alone, no Hollow Knight guards; the fog lets you back out; his later phases keep the first phase's wind-up and recovery and never raise a shield (the dark, the sprites and the lines stay) | you still cannot strike or be struck across the threshold |
