...
describe('two-handed runtime', () => {
  it('suppresses every offhand contribution and preserves handling fields', () => {
    ...
    expect(d.swing).toMatchObject({ sweep: true, stagger: 0.3, chips: 2 });
  });

  it('sweeps three adjacent tiles, never bashes, double-chips, and wears at most twice', () => {
