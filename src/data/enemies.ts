...
export const ENEMIES: EnemyDef[] = [
  {
    ...
    loot: [{ id: 'rat_hide', chance: 0.42, min: 1, max: 2 }, { id: 'bone', chance: 0.17, min: 1, max: 1 }],
  ...
  },
  {
    ...
    loot: [
      ...
      { id: 'bone_idol', chance: 0.07, min: 1, max: 1 },
    ],
  ...
  },
  {
    ...
    loot: [{ id: 'rat_hide', chance: 0.32, min: 1, max: 1 }, { id: 'bone', chance: 0.21, min: 1, max: 1 }],
  ...
  },
  {
    ...
    loot: [{ id: 'spider_silk', chance: 0.42, min: 1, max: 2 }, { id: 'crystal', chance: 0.06, min: 1, max: 1 }],
  ...
  },
  {
    ...
    loot: [
      ...
      { id: 'bone', chance: 0.35, min: 1, max: 3 },
      { id: 'silver_chalice', chance: 0.08, min: 1, max: 1 },
    ],
