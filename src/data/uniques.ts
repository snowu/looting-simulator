...
export const UNIQUES: UniqueDef[] = [
  {
    ...
    effect: 'never_dulls',
    power: 0,
    rule: 'Never dulls: 0 durability lost per blow, ever. +8 Attack over a star-iron long sword, and no repair bill for the rest of its life.',
  ...
  },
  {
    ...
    effect: 'parry_feed',
    power: 0.25,
    rule: 'Every blow turned aside feeds it: +25% damage per parry, stacking to 3 (+75%). One unblocked hit drops it to 0. Blocked hits keep the stack.',
  ...
  },
  {
    ...
    effect: 'undead_bane',
    power: 1.7,
    rule: '+70% damage to anything undead — skeletons, ghouls, wraiths and the King himself. Nothing at all against the living.',
  ...
  },
  {
    ...
    power: 1,
    rule: 'A parried melee blow deals 100% of the attacker\'s own damage straight back into it, at its own damage type — on top of the parry stun and the doubled damage that follows.',
  ...
  },
  {
    ...
    effect: 'lantern',
    power: 4,
    rule: '+4 light radius, taking your lamp from 9.5 to 13.5 before any Lantern Wick... BUT −42 Block %, which leaves this buckler absorbing 7-15% where a plain gold one takes 45%.',
  ...
  },
  {
    ...
    effect: 'half_healing',
    power: 0.5,
    rule: '+14 Defense and +20 Health on top of star-iron plate, the heaviest armour in the dark... BUT every draught, shrine and drop of leeched blood heals exactly 50% while you wear it.',
  ...
  },
  {
    ...
    effect: 'trap_sense',
    power: 2,
    rule: '+2 tiles of trap-reading: plates, pits and wards spotted 4 tiles ahead down a clear line instead of 2.',
  ...
  },
  {
    ...
    power: 1.7,
    rule: 'Drunk, and it lasts the rest of the delve: stamina recovers 70% faster, 34/s to 57.8/s... BUT −20 maximum stamina, and a second bottle does nothing.',
  ...
  },
  {
    ...
    effect: 'unseen',
    power: 2,
    rule: '−2 tiles off every creature\'s sight: a skeleton that sees 7 tiles notices you at 5. Stacks against the Hunted curse, which gives 2 back.',
