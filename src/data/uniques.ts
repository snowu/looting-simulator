...
export const UNIQUES: UniqueDef[] = [
  ...
  },
  {
    ...
    effect: 'parry_feed',
    power: 0.25,
    rule: 'Every blow turned aside feeds it: +25% damage per parry, up to three. One unblocked hit and it starts over.',
  ...
  },
  {
    ...
    effect: 'lantern',
    power: 4,
    rule: 'Carries a far wider light... BUT it is a candle bracket, not a shield, and it stops almost nothing.',
  ...
  },
  {
    ...
    effect: 'half_healing',
    power: 0.5,
    rule: 'The best armour in the dark... BUT every draught, shrine and drop of leeched blood does half as much while you wear it.',
  ...
  },
  {
    ...
    power: 1.7,
    rule: 'Drunk, and it lasts the rest of the delve: wind comes back 70% faster... BUT there is a good deal less of it to come back to.',
