...
export const MATERIALS: MaterialDef[] = [
  ...
  { id: 'deep_yew', name: 'Deep Yew', category: 'wood', tier: 4, rarity: Rarity.Epic, value: 160,
    icon: 'ic_plank', ramp: ['#2a0c0c', '#5a1c16', '#8a3424', '#c0644a'], mods: { speed: 7 },
  ...
  { id: 'starwood', name: 'Starwood', category: 'wood', tier: 5, rarity: Rarity.Legendary, value: 420,
    icon: 'ic_plank', ramp: ['#1c2438', '#3e5478', '#7c9cc8', '#d4e6ff'], mods: { speed: 10 },
  ...
  { id: 'wool', name: 'Wool', category: 'cloth', tier: 2, rarity: Rarity.Uncommon, value: 14,
    icon: 'ic_cloth', ramp: ['#3a1010', '#6a2020', '#a0443a', '#d88a70'], mods: { stamina: 6 },
  ...
  { id: 'astral_silk', name: 'Astral Silk', category: 'cloth', tier: 5, rarity: Rarity.Legendary, value: 400,
    icon: 'ic_cloth', ramp: ['#0c1c3a', '#1c3c7a', '#3c78c0', '#a0e0ff'], mods: { stamina: 30 },
  ...
  { id: 'dense_bone', name: 'Dense Bone', category: 'bone', tier: 2, rarity: Rarity.Uncommon, value: 12,
    icon: 'ic_bone', ramp: ['#26262a', '#4e4e56', '#86868e', '#c8c8cc'], mods: { attack: 3 },
  ...
  { id: 'fossil_bone', name: 'Fossil Bone', category: 'bone', tier: 3, rarity: Rarity.Rare, value: 40,
    icon: 'ic_bone', ramp: ['#3a2410', '#6e4420', '#a8703a', '#dcae70'], mods: { attack: 6 },
  ...
  { id: 'titan_bone', name: 'Titan Bone', category: 'bone', tier: 5, rarity: Rarity.Legendary, value: 410,
    icon: 'ic_bone', ramp: ['#28343c', '#526874', '#90a8b4', '#e0f0f8'], mods: { attack: 20 },
  ...
  // --- Gems (catalysts) ---------------------------------------------------
  {
    ...
    icon: 'ic_gem_cabochon', ramp: ['#0c342e', '#1e6456', '#4a9e86', '#a8e0c8'], mods: { health: 6 },
  ...
  },
  {
    ...
    icon: 'ic_shard', ramp: ['#4a2a44', '#8a5a80', '#d0a0c8', '#fff0fa'], mods: { stamina: 8 },
  ...
  },
  {
    ...
    icon: 'ic_gem_cabochon', ramp: ['#3a3a5a', '#7070a0', '#b0b0d8', '#f0f0ff'], mods: { luck: 3 },
  ...
  },
  {
    ...
    icon: 'ic_gem_emerald', ramp: ['#04301a', '#0a6030', '#10a050', '#70f0a0'], mods: { find: 8 },
  ...
  },
  {
    ...
    icon: 'ic_gem', ramp: ['#1a0a2e', '#3e1a6a', '#7040b0', '#c8a0f0'], mods: { focus: 4 },
