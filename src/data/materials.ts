...
export const MATERIALS: MaterialDef[] = [
  ...
  { id: 'deep_yew', name: 'Deep Yew', category: 'wood', tier: 4, rarity: Rarity.Epic, value: 160,
    icon: 'ic_plank', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { speed: 4, defense: 2 },
  ...
  { id: 'starwood', name: 'Starwood', category: 'wood', tier: 5, rarity: Rarity.Legendary, value: 420,
    icon: 'ic_plank', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { attack: 4, speed: 5 },
    description: 'Pale grain threaded with starlight. Strong enough for the deepest forge.' },
  { id: 'troll_hide', name: 'Troll Hide', category: 'hide', tier: 3, rarity: Rarity.Uncommon, value: 48,
    icon: 'ic_hide', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { health: 9 },
    description: 'Thick, stubborn hide. A useful step between leather and wyrm skin.' },
  { id: 'wool', name: 'Wool', category: 'cloth', tier: 2, rarity: Rarity.Common, value: 14,
    icon: 'ic_cloth', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { stamina: 3 },
  ...
  { id: 'astral_silk', name: 'Astral Silk', category: 'cloth', tier: 5, rarity: Rarity.Legendary, value: 400,
    icon: 'ic_cloth', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { stamina: 12, focus: 5, speed: 4 },
    description: 'A shimmering weave that carries a spell as readily as a stitch.' },
  { id: 'dense_bone', name: 'Dense Bone', category: 'bone', tier: 2, rarity: Rarity.Common, value: 12,
    icon: 'ic_bone', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { attack: 1 },
    description: 'Heavy cave-beast bone, clean enough to shape into a grip.' },
  { id: 'fossil_bone', name: 'Fossil Bone', category: 'bone', tier: 3, rarity: Rarity.Uncommon, value: 40,
    icon: 'ic_bone', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { attack: 2 },
  ...
  { id: 'wyrm_bone', name: 'Wyrm Bone', category: 'bone', tier: 4, rarity: Rarity.Epic, value: 150,
    icon: 'ic_bone', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { attack: 3, health: 9 },
  ...
  { id: 'titan_bone', name: 'Titan Bone', category: 'bone', tier: 5, rarity: Rarity.Legendary, value: 410,
    icon: 'ic_bone', ramp: ['#252030', '#554860', '#9984ac', '#dfd0ef'], mods: { attack: 5, health: 15 },
