...
// --- Your Shade ---------------------------------------------------------------------
// What the dark kept of you: a figure with no face and no kit of its own, only
// two cold points where the eyes were, the edges smoking off into the air and
// the legs gone to nothing by the knee. It carries the weapon and shield you
// carry, composited into its hands at draw time (`src/render/shade.ts`), so
// the only clear things about it are the ones that are yours.
// Every colour is emissive: no torch, not even its own glow, lights it up. It
// stays a hole in the room while the kit it holds catches the light.
const SHADE_PAL = { k: '#040508fa', a: '#0c0f17fa', b: '#161b28fa', c: '#252d42fa', e: '#8aa4e0fa' };
const SHADE_REST = rows(`
  ........................................
  ........................................
  ........................................
  ........................................
...
export const ENEMY_ART_B: ArtDef[] = [
  ...
  { id: 'shade_0', palette: SHADE_PAL, rows: SHADE_REST },
  { id: 'shade_atk', palette: SHADE_PAL, rows: SHADE_ATK },
