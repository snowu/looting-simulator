...
/** A grave lid set into the Ossuary floor: one long bevelled slab with a cross cut in it. */
const GRAVE_ROWS = rows(`
  ................................
  .....mmmmmmmmmmmmmmmmmmmmmm.....
  .....mccccccccccccccccccccm.....
  .....mcbbbbbbbbbbbbbbbbbbam.....
  .....mcbeeeeeeeeeeeeeeeebam.....
  .....mcbeaaaaaaaaaaaaaaebam.....
  .....mcbebbbbbbbbbbbbbbebam.....
  .....mcbebbbbbbbbbbbbbbeaam.....
  .....mcbebbbbbbeebbbbbbeeam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebbeeeeeeceeebbebam.....
  .....mcbebbeeeeeeceeebbebam.....
  .....mcbebbbcccccccccbbebam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebbbbbbeecbbbbbebam.....
  .....mcbebebbbbeecbbbbbebam.....
  .....mcbebbebbbeecbbbbbebam.....
  .....mcbebbbebbeecbbbbbebam.....
  .....mcbebbbebbbbbbbbbbebam.....
  .....mcbebbbbeebbbbbbbbebam.....
  .....mcbebbbbbbbbbbbbbbebam.....
  .....mcbebbbbbbbbbbbbbbebam.....
  .....mcbeeeeeeeeeeeeeeeebam.....
  .....mcbbbbbbbbbbbbbbbbbbam.....
  .....mcaaaaaaaaaaaaaaaaaaam.....
  .....mmmmmmmmmmmmmmmmmmmmmm.....
  ................................
`);
/** An iron drain grate over a black hole, with a wet sheen on the stones round it. */
const DRAIN_ROWS = rows(`
  ................................
  ................................
  ................................
  ................................
  ...
  ................................
`);
/** Spoil on the mine floor: chips of rock with copper in them, one catching the light. */
const ORE_ROWS = rows(`
  ................................
  ................................
  ................................
  ...
  ................................
`);
/** A miner's pick someone dropped and never came back for. */
const PICK_ROWS = rows(`
  ................................
  ................................
  ................................
  ................................
...
const BURROW_TRACK = rows(`
  ...
  .....q.......q
`);
// Now and then a Sporegrove floor tile has moss creeping over it, with a
// few glowing sprouts.
const CAVE_FLOOR_MOSS = rows(`
  ................................
  .......fff......................
  ....fffggf......................
  ...fggggggf.....................
  ...
  ................................
`);
// Extra faces for the Burrows and the Sporegrove, so a long wall there is not
// one texture stamped end to end. Burrows: stones half-buried in the earth,
// and claw gouges where something dug. Sporegrove: moss hanging from the top
// of the wall with a few lit spores, and two bracket fungi growing out of it.
const BURROW_STONES = rows(`
  ................................
  ................................
  ........................eeee....
  .......................euuute...
...
const BURROW_CLAWS = rows(`
  ...
  ................................
`);
const CAVE_MOSS = rows(`
  hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
  hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
  gggggggggggggggggg.gggggggggg.gg
  gggg.ggggg.ggggggg.ggggggg.gg.gg
  gggg.gg.gg.gg.gggg.gg.qggg.gg.gg
  g..gq.g.g..g..g.gg.gg.gggg.gg.g.
  g..g..g.g..g..g.gg.g..g..g.gg...
...
export const TEXTURES: ArtDef[] = [
  ...
  { id: 'floor_crypt_grave', base: 'floor_crypt', palette: { m: '#0a090c', e: '#121015', a: '#34313a', b: '#4a4652', c: '#625d6a' }, rows: GRAVE_ROWS },
  { id: 'floor_crypt_drain', base: 'floor_crypt', palette: { k: '#000000', i: '#4a4a54', n: '#8a8a96', e: '#141217', w: '#5a6e7a' }, rows: DRAIN_ROWS },
  ...
  { id: 'floor_mine_ore', base: 'floor_mine', palette: { k: '#0e0905', r: '#4e3c2a', s: '#725a40', o: '#d07830', g: '#ffc070fa' }, rows: ORE_ROWS },
  { id: 'floor_mine_pick', base: 'floor_mine', palette: { k: '#0e0905', w: '#8a6038', y: '#4a2e18', i: '#666670', n: '#b0b0ba' }, rows: PICK_ROWS },
  ...
  { id: 'wall_cave_moss', base: 'wall_cave', palette: { g: '#2a4a26', h: '#3e6a34', q: '#b8ff90fa' }, rows: CAVE_MOSS },
  { id: 'wall_cave_shelf', base: 'wall_cave', palette: { m: '#050a09', H: '#b89a70', F: '#8a7050', E: '#5a4432', q: '#b8ff90fa' }, rows: CAVE_SHELF },
  ...
  { id: 'floor_cave_moss', base: 'floor_cave_dirt', palette: { f: '#1a3018', g: '#24401e', h: '#325a28', q: '#b8ff90fa' }, rows: CAVE_FLOOR_MOSS },
  ...
  { id: 'wall_burrows_stones', palette: { ...BURROW_WALL, s: '#3c3a3e', t: '#5a5860', u: '#7c7a84' }, rows: stamp(DIRT_ROWS, BURROW_STONES) },
  { id: 'wall_burrows_claws', palette: BURROW_WALL, rows: stamp(DIRT_ROWS, BURROW_CLAWS) },
