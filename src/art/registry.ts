...
export const ALL_ART: ArtDef[] = [...TEXTURES, ...FROST_TEXTURES, ...PROPS, ...BIOME_PROPS, ...ICONS, ...UI_ART, ...ENEMY_ART_A, ...ENEMY_ART_B, ...ENEMY_ART_VARIETY, ...ENEMY_ART_ELEMENTAL, ...ENEMY_ART_BIOMES, ...VIEWMODELS];
