...
// The gripping fist, seen from behind: a lit knuckle crown, three broad
// fingers split by single grooves, the thumb wedged on the left in shadow,
// one short palm crease, then a leather bracer cuff and a dark sleeve running
// off toward the bottom-right corner. Deliberately coarse — at the size this
// is drawn, every extra crease and tone is noise, and the hand before this
// one had that noise: four fiddly fingers checkerboarding against the thumb.
const HAND = rows(`
  ........kddddddk........
  ........kddkdddk........
  ........kddkddkdk.......
