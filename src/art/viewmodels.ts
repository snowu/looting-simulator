...
// The gripping fist, seen from behind: a lit knuckle crown, fingers split by
// vertical creases, the thumb massed on the left in shadow, one palm crease,
// then a leather bracer cuff with strap lines and a dark sleeve running off
// toward the bottom-right corner. The separations run *along* the fingers —
// the old hand banded them across, which read as wrapping rather than
// knuckles, and the forearm was more of the same stripes instead of an arm.
const HAND = rows(`
  .........kddddk.........
  ........kddaddaddk......
  ........kddaddadddk.....
