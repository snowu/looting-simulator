...
// The gripping fist, seen from behind: a lit knuckle crown, short grooves
// that split only the knuckles, fingers merged into lit masses below, the
// thumb a lit wedge on the left, then a bracer cuff with a bright rim and a
// dark sleeve. Learnt from the in-game shots: torch light crushes mid-tones,
// so full-length black grooves read as holes and a shadowed thumb as a blob.
// Separations are dark brown, two rows tall, at the knuckle line only — below
// that a fist is one united mass catching the light.
const HAND = rows(`
  ........kddddddk........
  ........kddaddak........
  ........kddaddak........
