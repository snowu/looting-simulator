...
const SKIP = {
  ...
  'd4013dc': 'revert of the cute Spore hunter (86e0e12); restores the Patch 86 art as it was',
  '86e0e12': 'Spore hunter redraw, reverted in d4013dc; never shipped',
  ...
  '9483208': 'Patch 86 citation of the material colours only',
  '4ed5178': 'consumable icon PR sheets, docs and patch_notes.md wording; the art is Patch 86',
  'fa8413d': 'Patch 86 citation of the consumable icons only',
  '7100b45': 'material icon PR sheets, docs and patch_notes.md wording; the art is Patch 86',
  'd2fd458': 'Patch 86 citation of the material icons only',
  'e31a47d': 'mole PR sheet, 3D shot, docs and patch_notes.md wording; the art is Patch 86',
  '9cc8abc': 'Patch 86 citation of the mole claws only',
  '7c969c0': 'handoff doc note on PR image URLs only',
